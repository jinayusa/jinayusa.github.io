        ...
        >
          <div className="relative isolate w-full aspect-square mt-[30%]">
            <motion.div
              ...
              <span className="text-cyan-400 tracking-wide uppercase text-sm pt-[0%] ">About&nbsp;me</span>
            </motion.div>
            ...
            <img
              ...
              className="elative z-10 w-full aspect-square object-cover rounded-lg shadow-lg"
            />
          ...
          {showEducation && (
            <section className="w-full bg-transparent py-20 px-4 sm:px-8 flex flex-col items-center justify-center text-gray-600 dark:text-gray-300">
     <h2 className="text-4xl sm:text-5xl font-bold mb-12 text-center tracking-tight text-gray-600 dark:text-gray-300">
  Education
</h2>
              ...
              <div className="flex flex-col gap-8 max-w-2xl w-full">
                <div className="rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 p-6 sm:p-8 text-white shadow-md hover:shadow-xl transition duration-300">
                  <h3 className="text-xl font-semibold mb-1 text-gray-600 dark:text-gray-300">Arizona State University</h3>
                ...
                <div className="rounded-2xl bg-white/5 backdrop-blur-lg border border-white/10 p-6 sm:p-8 text-white shadow-md hover:shadow-xl transition duration-300 text-gray-600 dark:text-gray-300">
                  <h3 className="text-xl font-semibold mb-1 text-gray-600 dark:text-gray-300">Uka Tarsadia University</h3>
                  <p className="text-sm text-neutral-400 mb-1">
